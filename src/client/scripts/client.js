...
window.onload = function () {
  ...
  socket.on("updatePlayers", (playersInfo) => {
    ...
    if (playersInfo.redSpy.username === null) func.addNameToDOM("", redSpyList);
